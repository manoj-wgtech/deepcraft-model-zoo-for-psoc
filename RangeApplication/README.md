...
For accurate operation of the Range Application, the radar kit must be positioned correctly to ensure reliable distance detection within the sensing area.
...
<img src="./readme_assets/Kit_Placement.png" alt="Range Application Kit Placement" width="640" height="480">
